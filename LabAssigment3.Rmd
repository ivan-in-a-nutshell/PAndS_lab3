...
Our goals are:
To verify whether the confidence intervals of nominal level 1 − α contain the true parameter 𝜃 approximately 100(1 − α)% of the time.
...
Coverage extremely close to 1 − α
